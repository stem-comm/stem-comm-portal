...
* **Repository Ownership:** The repository is owned by the stem-comm GitHub Organization to ensure continuity when students graduate. Ensure at least one permanent UNCC staff member has "Owner" rights to this GitHub Organization. This is an independent project site and is not an official webpage of UNC Charlotte. While developed by university researchers, the content is managed independently and does not imply official endorsement or control by the University
